describe("Navigation and Rendering", () => {
    ...
    it("should navigate to the random-string page and back", () => {
        ...
        cy.intercept("GET", "/api/random-string", (req) => {
            console.log("Intercepted request:", req);
            req.reply((res) => {
                console.log("Response:", res);
                res.send({ randomString: "mockedString" }); // Mock response
            });
        }).as("fetchRandomString");
        // Intercept the API call to fetch the random string
